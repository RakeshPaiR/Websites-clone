...
class Signupform extends Component {
    render() {
        return (
            <div className={classNames(styles['px-4'], styles['py-4'], styles['form-div'])}>
                <form>
                    <div className={classNames(styles['form-group'])}>
                        <label htmlFor="username" className={classNames(styles['form-label'], styles['mb-5'], styles['f-14'])}>Username</label>
                        <input type="text" name="username" id="username" className={classNames(styles['form-input'])} />
                    </div>
                    <div className={classNames(styles['form-group'])}>
                        <label htmlFor="email" className={classNames(styles['form-label'], styles['mb-5'], styles['f-14'])}>Email</label>
                        <input type="email" name="email" id="email" className={classNames(styles['form-input'])} />
                    </div>
                    <div className={classNames(styles['form-group'])}>
                        <label htmlFor="password" className={classNames(styles['form-label'], styles['mb-5'], styles['f-14'])}>Password</label>
                    ...
                    <div className={classNames()}>
                        <p className={classNames(styles['f-12'], styles['agree'])}>By clicking “Sign up for GitHub”, you agree to our <a href="#">Terms of Service</a> and <a href="#">Privacy Statement</a>. We’ll occasionally send you account related emails.</p>
                    </div>
                </form>
            </div>
        );
