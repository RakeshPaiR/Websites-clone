...
class Navbar extends Component {
    ...
    sideBarDropdown = (event) => {
        console.log(event);
        if (event.target.classList.contains(styles['active'])) {
            event.target.classList.remove(styles['active']);
            event.target.classList.add(styles['inactive']);
        }
        else {
            event.target.classList.remove(styles['inactive']);
        ...
        return (
            <div className={classNames(styles['navbar'], styles['text-white'], styles['center'])}>
                ...
                <div className={classNames(styles['navbar-item'])}>
                    <a href="#">Why Github? <svg x="0px" y="0px" viewBox="0 0 14 8" className={classNames(styles['drop-down-svg'])}><path d="M1,1l6.2,6L13,1"></path></svg></a>
                ...
                <div className={classNames(styles['navbar-item'])}>
                    <a href="#">Explore <svg x="0px" y="0px" viewBox="0 0 14 8" className={classNames(styles['drop-down-svg'])}><path d="M1,1l6.2,6L13,1"></path></svg></a>
                    <div className={classNames(styles['dropdown'], styles['box-shadow'])}>
                        <a href="#" className={classNames(styles['bold'])}>Explore Github</a>
                        <hr></hr>
                        <a href="#">Topics</a>
                ...
                <div className={classNames(styles['navbar-item'])}>
                    <a href="#">Pricing <svg x="0px" y="0px" viewBox="0 0 14 8" className={classNames(styles['drop-down-svg'])}><path d="M1,1l6.2,6L13,1"></path></svg></a>
                    <div className={classNames(styles['dropdown'], styles['box-shadow'])}>
                ...
                {menuBarToggle &&
                    <div className={classNames(styles['sidebar'], styles['box-shadow'])}>
                        ...
                        <hr></hr>
                        <div className={classNames(styles['navbar-item'])}>
                            <svg x="0px" y="0px" viewBox="0 0 14 8" className={classNames(styles['drop-down-svg'])}><path d="M1,1l6.2,6L13,1"></path></svg>
                            <a href="#" onClick={this.sideBarDropdown}>Why Github?</a>
                            <div className={classNames(styles['dropdown'])}>
                                ...
                                <a href="#">Team management</a>
                                <a href="#">Hosting</a>
                                <a href="#" className={classNames(styles['bold'], styles['margin-top-2'])}>Customer stories</a>
                                <a href="#" className={classNames(styles['bold'])}>Security</a>
                            </div>
                        </div>
                        <hr></hr>
                        ...
                        <div className={classNames(styles['navbar-item'])}>
                            <svg x="0px" y="0px" viewBox="0 0 14 8" className={classNames(styles['drop-down-svg'])}><path d="M1,1l6.2,6L13,1"></path></svg>
                            <a href="#" onClick={this.sideBarDropdown}>Explore</a>
                            <div className={classNames(styles['dropdown'])}>
                                <a href="#" className={classNames(styles['bold'])}>Explore Github</a>
                                <a href="#">Topics</a>
                                <a href="#">Collections</a>
                        ...
                        <div className={classNames(styles['navbar-item'])}>
                            <svg x="0px" y="0px" viewBox="0 0 14 8" className={classNames(styles['drop-down-svg'])}><path d="M1,1l6.2,6L13,1"></path></svg>
                            <a href="#" onClick={this.sideBarDropdown}>Pricing</a>
                            <div className={classNames(styles['dropdown'])}>
                                <a href="#" className={classNames(styles['bold'])}>Plans</a>
                                <a href="#">Compare plans</a>
                                <a href="#">Contact sales</a>
                                <a href="#" className={classNames(styles['bold'], styles['margin-top-2'])}>Nonprofit</a>
                                <a href="#" className={classNames(styles['bold'])}>Education</a>
                            </div>
                        </div>
                        <hr></hr>
                        <div className={classNames(styles['navbar-item'], styles['solid-border'], styles['padding-0'], styles['margin-top-4'])}>
                            <input type="text" placeholder="Search Github"></input>
                            <img src="https://github.githubassets.com/images/search-key-slash.svg" alt="" class="mr-2 header-search-key-slash"></img>
                        </div>
                        <div className={classNames(styles['navbar-item'], styles['display-flex'], styles['padding-2'], styles['margin-top-2'], styles['center'])}>
                            <div className={classNames(styles['padding-2'])}>Sign in</div>
                            <div className={classNames(styles['solid-border'], styles['padding-2'])}>Sign up</div>
                        </div>
                    </div>
                }
            </div >
